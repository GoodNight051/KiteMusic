 ...
 * Original file: /npm/@tailwindcss/browser@4.1.1/dist/index.global.js
 *
...
(() => {
            ...
            if (92 === p) u += t.slice(f, f + 2), f += 1;
                ...
                for (let n = f + 1; n < t.length; n++)
                    if (o = t.charCodeAt(n), 92 === o) n += 1;
                        ...
                        if (59 === o && t.charCodeAt(n + 1) === e) throw new Error(`Unterminated string: ${t.slice(r,n+1)+String.fromCharCode(p)}`);
                        if (o === e) throw new Error(`Unterminated string: ${t.slice(r,n)+String.fromCharCode(p)}`)
                    } u += t.slice(r, f + 1)
            } else {
                if ((32 === p || p === e || 9 === p) && (o = t.charCodeAt(f + 1)) && (32 === o || o === e || 9 === o)) continue;
                if (p === e) {
                ...
                } else if (59 === p && 64 === u.charCodeAt(0)) c = r(u), s ? s.nodes.push(c) : a.push(c), u = "", c = null;
                else if (59 === p && ")" !== d[d.length - 1]) {
                    let e = n(u);
                    if (!e) throw 0 === u.length ? new Error("Unexpected semicolon") : new Error(`Invalid declaration: \`
                        $ {
                            u.trim()
                        }\
                        ``);
                    s ? s.nodes.push(e) : a.push(e), u = ""
                } else if (123 === p && ")" !== d[d.length - 1]) d += "}", c = b(u.trim()), s && s.nodes.push(c), l.push(s), s = c, u = "", c = null;
                else if (125 === p && ")" !== d[d.length - 1]) {
                    if ("" === d) throw new Error("Missing opening {");
                    if (d = d.slice(0, -1), u.length > 0)
                        if (64 === u.charCodeAt(0)) c = r(u), s ? s.nodes.push(c) : a.push(c), u = "", c = null;
                        else {
                            let e = u.indexOf(":");
                            if (s) {
                                let t = n(u, e);
                                if (!t) throw new Error(`Invalid declaration: \`
                                    $ {
                                        u.trim()
                                    }\
                                    ``);
    ...
    var s = class {
            ...
            add(e, t, r = 0) {
                if (e.endsWith("-*")) {
                    if ("initial" !== t) throw new Error(`Invalid theme value \`
                        $ {
                            t
                        }\
                        ` for namespace \`
            ...
            keysInNamespaces(e) {
                ...
                for (let r of e) {
                    let e = `${r}-`;
                    for (let n of this.values.keys()) n.startsWith(e) && -1 === n.indexOf("--", 2) && (l(n, r) || t.push(n.slice(e.length)))
                }
                return t
            }
            get(e) {
        ...
        for (let n = 0; n < e.length; n++) {
            let o = e[n],
                ...
                l = t(o, {
                    parent: r,
                    replaceWith(t) {
                        a || (a = !0, Array.isArray(t) ? 0 === t.length ? (e.splice(n, 1), i = 0) : 1 === t.length ? (e[n] = t[0], i = 1) : (e.splice(n, 1, ...t), i = t.length) : e[n] = t)
                    }
                }) ?? 0;
            if (a) 0 === l ? n-- : n += i - 1;
            else {
                if (2 === l) return 2;
                if (1 !== l && "function" === o.kind && 2 === p(o.nodes, t, o)) return 2
            }
        }
    }
    ...
    function g(e) {
        let t = [];
        return p(m(e), (e => {
            if ("function" === e.kind && "var" === e.value) return p(e.nodes, (e => {
    ...
    function C(e, t, r = [], n = {}) {
        for (let o = 0; o < e.length; o++) {
            let a = e[o],
                i = r[r.length - 1] ?? null;
            if ("rule" === a.kind || "at-rule" === a.kind) r.push(a), C(a.nodes, t, r, n), r.pop();
    ...
    function T(e, t, r = 3) {
        ...
        function f(e, c, v = {}, w = 0) {
            if ("declaration" === e.kind) {
                ...
                if (2 & r && e.value.includes("color-mix(")) {
                    ...
                    if (p(r, (e => {
                            ...
                            p(e.nodes, ((e, {
                                ...
                                let o = e.nodes[0];
                                if (!o || "word" !== o.kind) return;
                                let a = t.theme.resolveValue(null, [o.value]);
                                a && (n = !0, r({
                                    kind: "word",
                                    value: a
                                }))
                            ...
                            let r = e.nodes[2];
                            "word" === r.kind && ("oklab" === r.value || "oklch" === r.value || "lab" === r.value || "lch" === r.value) && (r.value = "srgb")
                        })), n) {
                        let t = {
                                ...e,
                                value: h(r)
                ...
                for (let r of e.nodes) f(r, t.nodes, v, w + 1);
                "@keyframes" === e.name && v.theme && i.add(t), (t.nodes.length > 0 || "@layer" === t.name || "@charset" === t.name || "@custom-media" === t.name || "@namespace" === t.name || "@import" === t.name) && c.push(t)
        ...
        for (let e of i)
            ...
            let e = [];
            if (s.length > 0 && e.push(b(":root, :host", s)), u.length > 0 && e.push(b("*, ::before, ::after, ::backdrop", u)), e.length > 0) {
                let t = v.findIndex((e => !("comment" === e.kind || "at-rule" === e.kind && ("@charset" === e.name || "@import" === e.name || "@layer" === e.name && 0 === e.nodes.length))));
                v.splice(t < 0 ? v.length : t, 0, k("@supports", "((-webkit-hyphens: none) and (not (margin-trim: inline))) or ((-moz-orient: inline) and (not (color:rgb(from red r g b))))", [b("@layer base", e)]))
            }
        }
        return v.concat(n)
    }
    ...
    function I(e) {
        ...
        if ("(" === e[0] && ")" === e[e.length - 1]) {
            let t = W(e.slice(1, -1));
            return !M(t) || 0 === t.length || 0 === t.trim().length || "-" !== t[0] && "-" !== t[1] ? null : {
                kind: "arbitrary",
                value: `var(${t})`
            }
        }
    ...
    var Z = {
        ...
        "line-width": function(e) {
            return R(e, " ").every((e => se(e) || ne(e) || "thin" === e || "medium" === e || "thick" === e))
        },
        image: function(e) {
            let t = 0;
            for (let r of R(e, ","))
    ...
    var le = new RegExp(`^${te.source}(${["cm","mm","Q","in","pc","pt","px","em","ex","ch","rem","lh","rlh","vw","vh","vmin","vmax","vb","vi","svw","svh","lvw","lvh","dvw","dvh","cqw","cqh","cqi","cqb","cqmin","cqmax"].join("|")})$`);

    function se(e) {
        return le.test(e) || F(e)
    }
    var ce = new RegExp(`^${te.source}(${["deg","rad","grad","turn"].join("|")})$`);
    ...
    function we(e, t) {
        return R(e, ",").map((e => {
            let r = R(e = e.trim(), " ").filter((e => "" !== e.trim())),
                ...
                o = null,
                a = null;
            for (let e of r) ge.has(e) || (ve.test(e) ? (null === o ? o = e : null === a && (a = e), ve.lastIndex = 0) : null === n && (n = e));
    ...
    function $e(e, t, r) {
        return k("@property", e, [y("syntax", r ? `"${r}"` : '"*"'), y("inherits", "false"), ...t ? [y("initial-value", t)] : []])
    }
    ...
    function Te(e, t, r) {
        ...
        return n ? Ce(n, e.modifier, t) : null
    }
    ...
    function Se(e, t, r, n, o = "") {
        let a = !1,
            i = we(t, (e => null == r ? n(e) : e.startsWith("current") ? n(ze(e, r)) : ((e.startsWith("var(") || r.startsWith("var(")) && (a = !0), n(Ae(e, r)))));
        return a ? [y(e, o + we(t, n)), b("@supports (color: lab(from red l a b))", [y(e, o + i)])] : [y(e, o + i)]
    }

    function Ke(e, t, r, n, o = "") {
        let a = !1,
            i = R(t, ",").map((e => we(e, (e => null == r ? n(e) : e.startsWith("current") ? n(ze(e, r)) : ((e.startsWith("var(") || r.startsWith("var(")) && (a = !0), n(Ae(e, r))))))).map((e => `drop-shadow(${e})`)).join(" ");
        return a ? [y(e, o + R(t, ",").map((e => `drop-shadow(${we(e,n)})`)).join(" ")), b("@supports (color: lab(from red l a b))", [y(e, o + i)])] : [y(e, o + i)]
    }
    var Ee = {
        "--alpha": function(e, t, r, ...n) {
            let [o, a] = R(r, "/").map((e => e.trim()));
            if (!o || !a) throw new Error(`The --alpha(…) function requires a color and an alpha value, e.g.: \`--alpha($ {
                    o || "var(--my-color)"
                }
                / ${a||"50%"})\``);if(n.length>0)throw new Error(`The --alpha(…) function only accepts one argument, e.g.: \`--alpha(${o||"var(--my-color)"} /
                $ {
                    a || "50%"
                })``);
            return ze(o, a)
        ...
        "--theme": function(e, t, r, ...n) {
            ...
            if (!a) {
                ...
                throw new Error(`Could not resolve value for theme function: \`
                    theme($ {
                        r
                    })`. Consider checking if the variable name is correct or provide a fallback value to silence this error.`)
            }
        ...
        theme: function(e, t, r, ...n) {
            ...
            if (!o) throw new Error(`Could not resolve value for theme function: \`
                theme($ {
                    r
    ...
    var Ve = new RegExp(Object.keys(Ee).map((e => `${e}\\(`)).join("|"));

    function Ne(e, t) {
        let r = 0;
        return A(e, (e => {
            if ("declaration" === e.kind && e.value && Ve.test(e.value)) return r |= 8, void(e.value = Oe(e.value, e, t));
            "at-rule" === e.kind && ("@media" === e.name || "@custom-media" === e.name || "@container" === e.name || "@supports" === e.name) && Ve.test(e.params) && (r |= 8, e.params = Oe(e.params, e, t))
        })), r
    }
    ...
    function Ue(e) {
        ...
        return 0 === t.length ? [] : (t.sort(((e, t) => Fe(e.name, t.name))), function(e) {
            let t = [],
                r = null,
                n = new Map,
                o = new c((() => []));
            for (let a of e) {
                ...
                r || (r = {
                    ...
                    utility: e,
                    items: []
                }, n.set(e, r)), i ? o.get(e).push(a) : r.items.push(a)
            }
            ...
            let a = [];
            for (let e of t)
                for (let t of e.items) a.push([t.name, {
    ...
    function Le(e, t) {
        A(e, ((e, {
            ...
            else if ("at-rule" === e.kind && ("@keyframes" === e.name || "@property" === e.name)) return Object.assign(e, z([k(e.name, e.params, e.nodes)])), 1
        }))
    }
    ...
    function Re(e) {
        let t = function(e) {
                ...
                function o(n, o) {
                    ...
                    o.supportsNegative && t.functional(`-${n}`, a({
                        negative: !0
                    })), t.functional(n, a({
                        negative: !1
                    })), r(n, (() => [{
                ...
                function a(n, o) {
                    t.functional(n, (t => {
                        if (!t.value) return;
                        let r = null;
                        return "arbitrary" === t.value.kind ? (r = t.value.value, r = Ce(r, t.modifier, e)) : r = Te(t, e, o.themeKeys), null !== r ? o.handle(r) : void 0
                    })), r(n, (() => [{
                ...
                function i(n, a, i, {
                    ...
                    l && t.static(`-${n}-px`, (() => i("-1px"))), t.static(`${n}-px`, (() => i("1px"))), o(n, {
                        themeKeys: a,
                        supportsFractions: s,
                        supportsNegative: l,
                        defaultValue: null,
                ...
                n("w-screen", [
                    ...
                    ["max-height", "none"]
                ]), i("size", ["--size", "--spacing"], (e => [y("--tw-sort", "size"), y("width", e), y("height", e)]), {
                    supportsFractions: !0
                });
                for (let [e, t, r] of [
                ...
                t.static("container", (() => {
                    ...
                    for (let e of t) r.push(k("@media", `(width >= ${e})`, [y("max-width", e)]));
                    return r
                })), n("flex-auto", [
                    ["flex", "auto"]
                ]), n("flex-initial", [
                    ...
                    if (e.value) {
                        ...
                        if (e.value.fraction) {
                            ...
                            return de(t) && de(r) ? [y("flex", `calc(${e.value.fraction} * 100%)`)] : void 0
                        }
                    ...
                    ["flex-basis", "100%"]
                ]), i("basis", ["--flex-basis", "--spacing", "--container"], (e => [y("flex-basis", e)]), {
                    supportsFractions: !0
                }), n("table-auto", [
                    ["table-layout", "auto"]
                ]), n("table-fixed", [
                ...
                let l = () => z([$e("--tw-border-spacing-x", "0", "<length>"), $e("--tw-border-spacing-y", "0", "<length>")]);
                ...
                let s = () => z([$e("--tw-translate-x", "0"), $e("--tw-translate-y", "0"), $e("--tw-translate-z", "0")]);
                n("translate-none", [
                    ["translate", "none"]
                    ...
                    ["--tw-translate-y", "100%"],
                    ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]
                ]), i("translate", ["--translate", "--spacing"], (e => [s(), y("--tw-translate-x", e), y("--tw-translate-y", e), y("translate", "var(--tw-translate-x) var(--tw-translate-y)")]), {
                    supportsNegative: !0,
                    supportsFractions: !0
                });
                for (let e of ["x", "y"]) n(`-translate-${e}-full`, [s, [`--tw-translate-${e}`, "-100%"],
                    ...
                    ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]
                ]), i(`translate-${e}`, ["--translate", "--spacing"], (t => [s(), y(`--tw-translate-${e}`, t), y("translate", "var(--tw-translate-x) var(--tw-translate-y)")]), {
                    supportsNegative: !0,
                    supportsFractions: !0
                });
                i("translate-z", ["--translate", "--spacing"], (e => [s(), y("--tw-translate-z", e), y("translate", "var(--tw-translate-x) var(--tw-translate-y) var(--tw-translate-z)")]), {
                    supportsNegative: !0
                }), n("translate-3d", [s, ["translate", "var(--tw-translate-x) var(--tw-translate-y) var(--tw-translate-z)"]]);
                let c = () => z([$e("--tw-scale-x", "1"), $e("--tw-scale-y", "1"), $e("--tw-scale-z", "1")]);
                ...
                function u({
                    ...
                    return r => {
                        ...
                        let n;
                        return "arbitrary" === r.value.kind ? (n = r.value.value, [y("scale", n)]) : (n = e.resolve(r.value.value, ["--scale"]), !n && de(r.value.value) && (n = `${r.value.value}%`), n ? (n = t ? `calc(${n} * -1)` : n, [c(), y("--tw-scale-x", n), y("--tw-scale-y", n), y("--tw-scale-z", n), y("scale", "var(--tw-scale-x) var(--tw-scale-y)")]) : void 0)
                    }
                }
                n("scale-none", [
                    ["scale", "none"]
                ...
                function d({
                    ...
                    return r => {
                        ...
                        } else if (n = e.resolve(r.value.value, ["--rotate"]), !n && de(r.value.value) && (n = `${r.value.value}deg`), !n) return;
                ...
                }]));
                {
                    let e = ["var(--tw-rotate-x)", "var(--tw-rotate-y)", "var(--tw-rotate-z)", "var(--tw-skew-x)", "var(--tw-skew-y)"].join(" "),
                        a = () => z([$e("--tw-rotate-x", "rotateX(0)"), $e("--tw-rotate-y", "rotateY(0)"), $e("--tw-rotate-z", "rotateZ(0)"), $e("--tw-skew-x", "skewX(0)"), $e("--tw-skew-y", "skewY(0)")]);
                    for (let t of ["x", "y", "z"]) o(`rotate-${t}`, {
                        ...
                        handle: r => [a(), y(`--tw-rotate-${t}`, `rotate${t.toUpperCase()}(${r})`), y("transform", e)]
                    }), r(`rotate-${t}`, (() => [{
                        supportsNegative: !0,
                        values: ["0", "1", "2", "3", "6", "12", "45", "90", "180"],
                        valueThemeKeys: ["--rotate"]
                    ...
                    o("skew", {
                        ...
                        handle: t => [a(), y("--tw-skew-x", `skewX(${t})`), y("--tw-skew-y", `skewY(${t})`), y("transform", e)]
                    }), o("skew-x", {
                        supportsNegative: !0,
                        themeKeys: ["--skew"],
                        handleBareValue: ({
                        ...
                        handle: t => [a(), y("--tw-skew-x", `skewX(${t})`), y("transform", e)]
                    }), o("skew-y", {
                        supportsNegative: !0,
                        themeKeys: ["--skew"],
                        handleBareValue: ({
                        ...
                        handle: t => [a(), y("--tw-skew-y", `skewY(${t})`), y("transform", e)]
                    }), r("skew", (() => [{
                        supportsNegative: !0,
                        values: ["0", "1", "2", "3", "6", "12"],
                        valueThemeKeys: ["--skew"]
                        ...
                        let r = null;
                        return t.value ? "arbitrary" === t.value.kind && (r = t.value.value) : r = e, null !== r ? [a(), y("transform", r)] : void 0
                    })), r("transform", (() => [{
                        hasDefaultValue: !0
                    }])), n("transform-cpu", [
                        ["transform", e]
                ...
                let f = () => z([$e("--tw-pan-x"), $e("--tw-pan-y"), $e("--tw-pinch-zoom")]);
                ...
                n("snap-mandatory", [p, ["--tw-scroll-snap-strictness", "mandatory"]]), n("snap-proximity", [p, ["--tw-scroll-snap-strictness", "proximity"]]), n("snap-align-none", [
                ...
                n("grid-flow-row", [
                    ...
                    ["place-content", "end"]
                ]), n("place-content-center-safe", [
                    ["place-content", "safe center"]
                ]), n("place-content-end-safe", [
                    ...
                    ["place-items", "end"]
                ]), n("place-items-center-safe", [
                    ["place-items", "safe center"]
                ]), n("place-items-end-safe", [
                    ...
                    ["justify-items", "end"]
                ]), n("justify-items-center-safe", [
                    ["justify-items", "safe center"]
                ]), n("justify-items-end-safe", [
                    ["justify-items", "safe end"]
                ]), n("justify-items-stretch", [
                    ["justify-items", "stretch"]
                ]), i("gap", ["--gap", "--spacing"], (e => [y("gap", e)])), i("gap-x", ["--gap", "--spacing"], (e => [y("column-gap", e)])), i("gap-y", ["--gap", "--spacing"], (e => [y("row-gap", e)])), i("space-x", ["--space", "--spacing"], (e => [z([$e("--tw-space-x-reverse", "0")]), w(":where(& > :not(:last-child))", [y("--tw-sort", "row-gap"), y("--tw-space-x-reverse", "0"), y("margin-inline-start", `calc(${e} * var(--tw-space-x-reverse))`), y("margin-inline-end", `calc(${e} * calc(1 - var(--tw-space-x-reverse)))`)])]), {
                    supportsNegative: !0
                }), i("space-y", ["--space", "--spacing"], (e => [z([$e("--tw-space-y-reverse", "0")]), w(":where(& > :not(:last-child))", [y("--tw-sort", "column-gap"), y("--tw-space-y-reverse", "0"), y("margin-block-start", `calc(${e} * var(--tw-space-y-reverse))`), y("margin-block-end", `calc(${e} * calc(1 - var(--tw-space-y-reverse)))`)])]), {
                    supportsNegative: !0
                }), n("space-x-reverse", [() => z([$e("--tw-space-x-reverse", "0")]), () => w(":where(& > :not(:last-child))", [y("--tw-sort", "row-gap"), y("--tw-space-x-reverse", "1")])]), n("space-y-reverse", [() => z([$e("--tw-space-y-reverse", "0")]), () => w(":where(& > :not(:last-child))", [y("--tw-sort", "column-gap"), y("--tw-space-y-reverse", "1")])]), n("accent-auto", [
                    ["accent-color", "auto"]
                ]), a("accent", {
                    ...
                    handle: e => [w(":where(& > :not(:last-child))", [y("--tw-sort", "divide-color"), y("border-color", e)])]
                }), n("place-self-auto", [
                    ["place-self", "auto"]
                ]), n("place-self-start", [
                    ["place-self", "start"]
                    ...
                    ["place-self", "center"]
                ]), n("place-self-end-safe", [
                    ["place-self", "safe end"]
                ]), n("place-self-center-safe", [
                    ...
                    ["justify-self", "center"]
                ]), n("justify-self-end-safe", [
                    ["justify-self", "safe flex-end"]
                ]), n("justify-self-center-safe", [
                ...
                ]);
                {
                    let a = function(n, o) {
                            t.functional(n, (t => {
                                ...
                                if ("arbitrary" === t.value.kind) {
                                    let r = t.value.value;
                                    switch (t.value.dataType ?? G(r, ["color", "line-width", "length"])) {
                                        case "line-width":
                                        case "length": {
                                            if (t.modifier) return;
                                            let e = o.width(r);
                                        ...
                                        default:
                                            return r = Ce(r, t.modifier, e), null === r ? void 0 : o.color(r)
                                    }
                                } {
                    ...
                    a("border", {
                        ...
                        handle: e => [z([$e("--tw-divide-x-reverse", "0")]), w(":where(& > :not(:last-child))", [y("--tw-sort", "divide-x-width"), i(), y("--tw-divide-x-reverse", "0"), y("border-inline-style", "var(--tw-border-style)"), y("border-inline-start-width", `calc(${e} * var(--tw-divide-x-reverse))`), y("border-inline-end-width", `calc(${e} * calc(1 - var(--tw-divide-x-reverse)))`)])]
                    }), o("divide-y", {
                        defaultValue: e.get(["--default-border-width"]) ?? "1px",
                        themeKeys: ["--divide-width", "--border-width"],
                        handleBareValue: ({
                        ...
                        handle: e => [z([$e("--tw-divide-y-reverse", "0")]), w(":where(& > :not(:last-child))", [y("--tw-sort", "divide-y-width"), i(), y("--tw-divide-y-reverse", "0"), y("border-bottom-style", "var(--tw-border-style)"), y("border-top-style", "var(--tw-border-style)"), y("border-top-width", `calc(${e} * var(--tw-divide-y-reverse))`), y("border-bottom-width", `calc(${e} * calc(1 - var(--tw-divide-y-reverse)))`)])]
                    }), r("divide-x", (() => [{
                        values: ["0", "2", "4", "8"],
                        ...
                        valueThemeKeys: ["--divide-width", "--border-width"],
                        hasDefaultValue: !0
                    }])), n("divide-x-reverse", [() => z([$e("--tw-divide-x-reverse", "0")]), () => w(":where(& > :not(:last-child))", [y("--tw-divide-x-reverse", "1")])]), n("divide-y-reverse", [() => z([$e("--tw-divide-y-reverse", "0")]), () => w(":where(& > :not(:last-child))", [y("--tw-divide-y-reverse", "1")])]);
                    for (let e of ["solid", "dashed", "dotted", "double", "none"]) n(`divide-${e}`, [() => w(":where(& > :not(:last-child))", [y("--tw-sort", "divide-style"), y("--tw-border-style", e), y("border-style", e)])])
                }
                n("bg-auto", [
                        ...
                        n = function({
                            ...
                            return r => {
                                ...
                                if ("arbitrary" === r.value.kind) {
                                    if (r.modifier) return;
                                    let e = r.value.value;
                                    return "angle" === (r.value.dataType ?? G(e, ["angle"])) ? (e = t ? `calc(${e} * -1)` : `${e}`, [y("--tw-gradient-position", e), y("background-image", `linear-gradient(var(--tw-gradient-stops,${e}))`)]) : t ? void 0 : [y("--tw-gradient-position", e), y("background-image", `linear-gradient(var(--tw-gradient-stops,${e}))`)]
                                }
                                let n = r.value.value;
                                ...
                                let o = e(r.modifier);
                                return [y("--tw-gradient-position", `${n}`), b("@supports (background-image: linear-gradient(in lab, red, red))", [y("--tw-gradient-position", `${n} ${o}`)]), y("background-image", "linear-gradient(var(--tw-gradient-stops))")]
                            }
                        },
                        o = function({
                            negative: t
                            ...
                            return r => {
                                ...
                                let o = r.value.value;
                                return de(o) ? (o = t ? `calc(${o}deg * -1)` : `${o}deg`, [y("--tw-gradient-position", `from ${o} ${n}`), y("background-image", "conic-gradient(var(--tw-gradient-stops))")]) : void 0
                            }
                        },
                ...
                t.functional("bg", (t => {
                    if (t.value) {
                        if ("arbitrary" === t.value.kind) {
                            let r = t.value.value;
                            switch (t.value.dataType ?? G(r, ["image", "color", "percentage", "position", "bg-size", "length", "url"])) {
                                case "percentage":
                                case "position":
                                ...
                                default:
                                    return r = Ce(r, t.modifier, e), null === r ? void 0 : [y("background-color", r)]
                            }
                        } {
                ...
                let h = () => z([$e("--tw-gradient-position"), $e("--tw-gradient-from", "#0000", "<color>"), $e("--tw-gradient-via", "#0000", "<color>"), $e("--tw-gradient-to", "#0000", "<color>"), $e("--tw-gradient-stops"), $e("--tw-gradient-via-stops"), $e("--tw-gradient-from-position", "0%", "<length-percentage>"), $e("--tw-gradient-via-position", "50%", "<length-percentage>"), $e("--tw-gradient-to-position", "100%", "<length-percentage>")]);
                ...
                function m(n, o) {
                    t.functional(n, (t => {
                        if (t.value) {
                            if ("arbitrary" === t.value.kind) {
                                let r = t.value.value;
                                switch (t.value.dataType ?? G(r, ["color", "length", "percentage"])) {
                                    case "length":
                                    case "percentage":
                ...
                m("from", {
                    color: e => [h(), y("--tw-sort", "--tw-gradient-from"), y("--tw-gradient-from", e), y("--tw-gradient-stops", "var(--tw-gradient-via-stops, var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-to) var(--tw-gradient-to-position))")],
                    position: e => [h(), y("--tw-gradient-from-position", e)]
                }), n("via-none", [
                    ["--tw-gradient-via-stops", "initial"]
                ]), m("via", {
                    color: e => [h(), y("--tw-sort", "--tw-gradient-via"), y("--tw-gradient-via", e), y("--tw-gradient-via-stops", "var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-via) var(--tw-gradient-via-position), var(--tw-gradient-to) var(--tw-gradient-to-position)"), y("--tw-gradient-stops", "var(--tw-gradient-via-stops)")],
                    position: e => [h(), y("--tw-gradient-via-position", e)]
                }), m("to", {
                    color: e => [h(), y("--tw-sort", "--tw-gradient-to"), y("--tw-gradient-to", e), y("--tw-gradient-stops", "var(--tw-gradient-via-stops, var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-to) var(--tw-gradient-to-position))")],
                    ...
                    let t = e.value.value;
                    switch (e.value.dataType ?? G(t, ["image", "percentage", "position", "bg-size", "length", "url"])) {
                        case "percentage":
                        case "position":
                    ...
                    ["mask-clip", "no-clip"]
                ]), n("mask-origin-border", [
                    ["mask-origin", "border-box"]
                ]), n("mask-origin-padding", [
                    ["mask-origin", "padding-box"]
                ]), n("mask-origin-content", [
                    ["mask-origin", "content-box"]
                ]), n("mask-origin-fill", [
                    ["mask-origin", "fill-box"]
                ]), n("mask-origin-stroke", [
                    ["mask-origin", "stroke-box"]
                ]), n("mask-origin-view", [
                    ["mask-origin", "view-box"]
                ]);
                let g = () => z([$e("--tw-mask-linear", "linear-gradient(#fff, #fff)"), $e("--tw-mask-radial", "linear-gradient(#fff, #fff)"), $e("--tw-mask-conic", "linear-gradient(#fff, #fff)")]);
                ...
                function v(n, o) {
                    t.functional(n, (t => {
                        if (t.value) {
                            if ("arbitrary" === t.value.kind) {
                                let r = t.value.value;
                                switch (t.value.dataType ?? G(r, ["length", "percentage", "color"])) {
                                    case "color":
                                        return r = Ce(r, t.modifier, e), null === r ? void 0 : o.color(r);
                                    case "percentage":
                                        return t.modifier || !de(r.slice(0, -1)) ? void 0 : o.position(r);
                                    default:
                                        return t.modifier ? void 0 : o.position(r)
                                }
                            } {
                                ...
                                switch (r) {
                                    case "number": {
                                        let r = e.resolve(null, ["--spacing"]);
                                        return r && pe(t.value.value) ? o.position(`calc(${r} * ${t.value.value})`) : void 0
                                    }
                                    case "percentage":
                ...
                let x = () => z([$e("--tw-mask-left", "linear-gradient(#fff, #fff)"), $e("--tw-mask-right", "linear-gradient(#fff, #fff)"), $e("--tw-mask-bottom", "linear-gradient(#fff, #fff)"), $e("--tw-mask-top", "linear-gradient(#fff, #fff)")]);

                function $(e, t, r) {
                    v(e, {
                        color(e) {
                            let n = [g(), x(), y("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), y("mask-composite", "intersect"), y("--tw-mask-linear", "var(--tw-mask-left), var(--tw-mask-right), var(--tw-mask-bottom), var(--tw-mask-top)")];
                            for (let o of ["top", "right", "bottom", "left"]) r[o] && (n.push(y(`--tw-mask-${o}`, `linear-gradient(to ${o}, var(--tw-mask-${o}-from-color) var(--tw-mask-${o}-from-position), var(--tw-mask-${o}-to-color) var(--tw-mask-${o}-to-position))`)), n.push(z([$e(`--tw-mask-${o}-from-position`, "0%"), $e(`--tw-mask-${o}-to-position`, "100%"), $e(`--tw-mask-${o}-from-color`, "black"), $e(`--tw-mask-${o}-to-color`, "transparent")])), n.push(y(`--tw-mask-${o}-${t}-color`, e)));
                            return n
                        },
                        position(e) {
                            let n = [g(), x(), y("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), y("mask-composite", "intersect"), y("--tw-mask-linear", "var(--tw-mask-left), var(--tw-mask-right), var(--tw-mask-bottom), var(--tw-mask-top)")];
                ...
                let A = () => z([$e("--tw-mask-linear-position", "0deg"), $e("--tw-mask-linear-from-position", "0%"), $e("--tw-mask-linear-to-position", "100%"), $e("--tw-mask-linear-from-color", "black"), $e("--tw-mask-linear-to-color", "transparent")]);
                o("mask-linear", {
                    defaultValue: null,
                    supportsNegative: !0,
                    supportsFractions: !1,
                    handleBareValue: e => de(e.value) ? `calc(1deg * ${e.value})` : null,
                    handleNegativeBareValue: e => de(e.value) ? `calc(1deg * -${e.value})` : null,
                    handle: e => [g(), A(), y("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), y("mask-composite", "intersect"), y("--tw-mask-linear", "linear-gradient(var(--tw-mask-linear-stops, var(--tw-mask-linear-position)))"), y("--tw-mask-linear-position", e)]
                }), r("mask-linear", (() => [{
                    supportsNegative: !0,
                    values: ["0", "1", "2", "3", "6", "12", "45", "90", "180"]
                }])), v("mask-linear-from", {
                    color: e => [g(), A(), y("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), y("mask-composite", "intersect"), y("--tw-mask-linear-stops", "var(--tw-mask-linear-position), var(--tw-mask-linear-from-color) var(--tw-mask-linear-from-position), var(--tw-mask-linear-to-color) var(--tw-mask-linear-to-position)"), y("--tw-mask-linear", "linear-gradient(var(--tw-mask-linear-stops))"), y("--tw-mask-linear-from-color", e)],
                    position: e => [g(), A(), y("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), y("mask-composite", "intersect"), y("--tw-mask-linear-stops", "var(--tw-mask-linear-position), var(--tw-mask-linear-from-color) var(--tw-mask-linear-from-position), var(--tw-mask-linear-to-color) var(--tw-mask-linear-to-position)"), y("--tw-mask-linear", "linear-gradient(var(--tw-mask-linear-stops))"), y("--tw-mask-linear-from-position", e)]
                }), v("mask-linear-to", {
                ...
                let C = () => z([$e("--tw-mask-radial-from-position", "0%"), $e("--tw-mask-radial-to-position", "100%"), $e("--tw-mask-radial-from-color", "black"), $e("--tw-mask-radial-to-color", "transparent"), $e("--tw-mask-radial-shape", "ellipse"), $e("--tw-mask-radial-size", "farthest-corner"), $e("--tw-mask-radial-position", "center")]);
                n("mask-circle", [
                ...
                ]), n("mask-radial-at-left", [
                    ["--tw-mask-radial-position", "left"]
                ]), n("mask-radial-at-right", [
                    ["--tw-mask-radial-position", "right"]
                ]), n("mask-radial-at-center", [
                    ...
                    supportsNegative: !1,
                    supportsFractions: !1,
                    handle: e => [g(), C(), y("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), y("mask-composite", "intersect"), y("--tw-mask-radial", "radial-gradient(var(--tw-mask-radial-stops, var(--tw-mask-radial-size)))"), y("--tw-mask-radial-size", e)]
                }), v("mask-radial-from", {
                    color: e => [g(), C(), y("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), y("mask-composite", "intersect"), y("--tw-mask-radial-stops", "var(--tw-mask-radial-shape) var(--tw-mask-radial-size) at var(--tw-mask-radial-position), var(--tw-mask-radial-from-color) var(--tw-mask-radial-from-position), var(--tw-mask-radial-to-color) var(--tw-mask-radial-to-position)"), y("--tw-mask-radial", "radial-gradient(var(--tw-mask-radial-stops))"), y("--tw-mask-radial-from-color", e)],
                    position: e => [g(), C(), y("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), y("mask-composite", "intersect"), y("--tw-mask-radial-stops", "var(--tw-mask-radial-shape) var(--tw-mask-radial-size) at var(--tw-mask-radial-position), var(--tw-mask-radial-from-color) var(--tw-mask-radial-from-position), var(--tw-mask-radial-to-color) var(--tw-mask-radial-to-position)"), y("--tw-mask-radial", "radial-gradient(var(--tw-mask-radial-stops))"), y("--tw-mask-radial-from-position", e)]
                }), v("mask-radial-to", {
                    color: e => [g(), C(), y("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), y("mask-composite", "intersect"), y("--tw-mask-radial-stops", "var(--tw-mask-radial-shape) var(--tw-mask-radial-size) at var(--tw-mask-radial-position), var(--tw-mask-radial-from-color) var(--tw-mask-radial-from-position), var(--tw-mask-radial-to-color) var(--tw-mask-radial-to-position)"), y("--tw-mask-radial", "radial-gradient(var(--tw-mask-radial-stops))"), y("--tw-mask-radial-to-color", e)],
                    position: e => [g(), C(), y("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), y("mask-composite", "intersect"), y("--tw-mask-radial-stops", "var(--tw-mask-radial-shape) var(--tw-mask-radial-size) at var(--tw-mask-radial-position), var(--tw-mask-radial-from-color) var(--tw-mask-radial-from-position), var(--tw-mask-radial-to-color) var(--tw-mask-radial-to-position)"), y("--tw-mask-radial", "radial-gradient(var(--tw-mask-radial-stops))"), y("--tw-mask-radial-to-position", e)]
                });
                let T = () => z([$e("--tw-mask-conic-position", "0deg"), $e("--tw-mask-conic-from-position", "0%"), $e("--tw-mask-conic-to-position", "100%"), $e("--tw-mask-conic-from-color", "black"), $e("--tw-mask-conic-to-color", "transparent")]);
                o("mask-conic", {
                    defaultValue: null,
                    supportsNegative: !0,
                    supportsFractions: !1,
                    handleBareValue: e => de(e.value) ? `calc(1deg * ${e.value})` : null,
                    handleNegativeBareValue: e => de(e.value) ? `calc(1deg * -${e.value})` : null,
                    handle: e => [g(), T(), y("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), y("mask-composite", "intersect"), y("--tw-mask-conic", "conic-gradient(var(--tw-mask-conic-stops, var(--tw-mask-conic-position)))"), y("--tw-mask-conic-position", e)]
                }), r("mask-conic", (() => [{
                    supportsNegative: !0,
                    values: ["0", "1", "2", "3", "6", "12", "45", "90", "180"]
                }])), v("mask-conic-from", {
                    color: e => [g(), T(), y("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), y("mask-composite", "intersect"), y("--tw-mask-conic-stops", "from var(--tw-mask-conic-position), var(--tw-mask-conic-from-color) var(--tw-mask-conic-from-position), var(--tw-mask-conic-to-color) var(--tw-mask-conic-to-position)"), y("--tw-mask-conic", "conic-gradient(var(--tw-mask-conic-stops))"), y("--tw-mask-conic-from-color", e)],
                    position: e => [g(), T(), y("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), y("mask-composite", "intersect"), y("--tw-mask-conic-stops", "from var(--tw-mask-conic-position), var(--tw-mask-conic-from-color) var(--tw-mask-conic-from-position), var(--tw-mask-conic-to-color) var(--tw-mask-conic-to-position)"), y("--tw-mask-conic", "conic-gradient(var(--tw-mask-conic-stops))"), y("--tw-mask-conic-from-position", e)]
                }), v("mask-conic-to", {
                ...
                n("mix-blend-plus-darker", [
                    ...
                    if (!t.value) return;
                    if ("arbitrary" === t.value.kind) {
                        let r = Ce(t.value.value, t.modifier, e);
                    ...
                    if (t.value) {
                        if ("arbitrary" === t.value.kind) {
                            let r = t.value.value;
                            switch (t.value.dataType ?? G(r, ["color", "number", "length", "percentage"])) {
                                case "number":
                                case "length":
                                case "percentage":
                                    return t.modifier ? void 0 : [y("stroke-width", r)];
                                default:
                                    return r = Ce(t.value.value, t.modifier, e), null === r ? void 0 : [y("stroke", r)]
                            }
                        } {
                ...
                ]), n("object-bottom-left", [
                    ["object-position", "left bottom"]
                ]), n("object-bottom-right", [
                ...
                n("text-left", [
                    ...
                    ["text-align", "end"]
                ]), i("indent", ["--text-indent", "--spacing"], (e => [y("text-indent", e)]), {
                    supportsNegative: !0
                }), n("align-baseline", [
                    ...
                    if (t.value && !t.modifier) {
                        if ("arbitrary" === t.value.kind) {
                            let e = t.value.value;
                            switch (t.value.dataType ?? G(e, ["number", "generic-name", "family-name"])) {
                                case "generic-name":
                                case "family-name":
                                    return [y("font-family", e)];
                                default:
                                    return [z([$e("--tw-font-weight")]), y("--tw-font-weight", e), y("font-weight", e)]
                            }
                        } {
                            ...
                            if (r) return [z([$e("--tw-font-weight")]), y("--tw-font-weight", r), y("font-weight", r)]
                        }
                    }
                })), r("font", (() => [{
                    values: [],
                    ...
                    handle: e => [w("&::placeholder", [y("--tw-sort", "placeholder-color"), y("color", e)])]
                }), n("decoration-solid", [
                    ...
                    if (t.value) {
                        if ("arbitrary" === t.value.kind) {
                            ...
                            switch (t.value.dataType ?? G(r, ["color", "length", "percentage"])) {
                                ...
                                default:
                                    return r = Ce(r, t.modifier, e), null === r ? void 0 : [y("text-decoration-color", r)]
                            }
                        } {
                            let r = e.resolve(t.value.value, ["--text-decoration-thickness"]);
                            if (r) return t.modifier ? void 0 : [y("text-decoration-thickness", r)];
                            if (de(t.value.value)) return t.modifier ? void 0 : [y("text-decoration-thickness", `${t.value.value}px`)]
                        } {
                ...
                {
                    let a = ["var(--tw-blur,)", "var(--tw-brightness,)", "var(--tw-contrast,)", "var(--tw-grayscale,)", "var(--tw-hue-rotate,)", "var(--tw-invert,)", "var(--tw-saturate,)", "var(--tw-sepia,)", "var(--tw-drop-shadow,)"].join(" "),
                        ...
                        l = () => z([$e("--tw-blur"), $e("--tw-brightness"), $e("--tw-contrast"), $e("--tw-grayscale"), $e("--tw-hue-rotate"), $e("--tw-invert"), $e("--tw-opacity"), $e("--tw-saturate"), $e("--tw-sepia"), $e("--tw-drop-shadow"), $e("--tw-drop-shadow-color"), $e("--tw-drop-shadow-alpha", "100%", "<percentage>"), $e("--tw-drop-shadow-size")]),
                        s = () => z([$e("--tw-backdrop-blur"), $e("--tw-backdrop-brightness"), $e("--tw-backdrop-contrast"), $e("--tw-backdrop-grayscale"), $e("--tw-backdrop-hue-rotate"), $e("--tw-backdrop-invert"), $e("--tw-backdrop-opacity"), $e("--tw-backdrop-saturate"), $e("--tw-backdrop-sepia")]);
                    t.functional("filter", (e => {
                        ...
                        if (!e.modifier) {
                            if (null === e.value) return [s(), y("-webkit-backdrop-filter", i), y("backdrop-filter", i)];
                        ...
                        themeKeys: ["--blur"],
                        handle: e => [l(), y("--tw-blur", `blur(${e})`), y("filter", a)]
                    }), n("blur-none", [l, ["--tw-blur", " "],
                        ["filter", a]
                    ]), o("backdrop-blur", {
                        themeKeys: ["--backdrop-blur", "--blur"],
                        handle: e => [s(), y("--tw-backdrop-blur", `blur(${e})`), y("-webkit-backdrop-filter", i), y("backdrop-filter", i)]
                    }), n("backdrop-blur-none", [s, ["--tw-backdrop-blur", " "],
                        ...
                        handle: e => [l(), y("--tw-brightness", `brightness(${e})`), y("filter", a)]
                    }), o("backdrop-brightness", {
                        themeKeys: ["--backdrop-brightness", "--brightness"],
                        handleBareValue: ({
                            value: e
                        }) => de(e) ? `${e}%` : null,
                        handle: e => [s(), y("--tw-backdrop-brightness", `brightness(${e})`), y("-webkit-backdrop-filter", i), y("backdrop-filter", i)]
                    }), r("brightness", (() => [{
                        values: ["0", "50", "75", "90", "95", "100", "105", "110", "125", "150", "200"],
                        ...
                        handle: e => [l(), y("--tw-contrast", `contrast(${e})`), y("filter", a)]
                    }), o("backdrop-contrast", {
                        themeKeys: ["--backdrop-contrast", "--contrast"],
                        handleBareValue: ({
                            value: e
                        }) => de(e) ? `${e}%` : null,
                        handle: e => [s(), y("--tw-backdrop-contrast", `contrast(${e})`), y("-webkit-backdrop-filter", i), y("backdrop-filter", i)]
                    }), r("contrast", (() => [{
                        ...
                        defaultValue: "100%",
                        handle: e => [l(), y("--tw-grayscale", `grayscale(${e})`), y("filter", a)]
                        ...
                        defaultValue: "100%",
                        handle: e => [s(), y("--tw-backdrop-grayscale", `grayscale(${e})`), y("-webkit-backdrop-filter", i), y("backdrop-filter", i)]
                    }), r("grayscale", (() => [{
                        ...
                        handle: e => [l(), y("--tw-hue-rotate", `hue-rotate(${e})`), y("filter", a)]
                        ...
                        handle: e => [s(), y("--tw-backdrop-hue-rotate", `hue-rotate(${e})`), y("-webkit-backdrop-filter", i), y("backdrop-filter", i)]
                    }), r("hue-rotate", (() => [{
                        ...
                        defaultValue: "100%",
                        handle: e => [l(), y("--tw-invert", `invert(${e})`), y("filter", a)]
                    }), o("backdrop-invert", {
                        ...
                        defaultValue: "100%",
                        handle: e => [s(), y("--tw-backdrop-invert", `invert(${e})`), y("-webkit-backdrop-filter", i), y("backdrop-filter", i)]
                    }), r("invert", (() => [{
                        values: ["0", "25", "50", "75", "100"],
                        ...
                        handle: e => [l(), y("--tw-saturate", `saturate(${e})`), y("filter", a)]
                    }), o("backdrop-saturate", {
                        themeKeys: ["--backdrop-saturate", "--saturate"],
                        handleBareValue: ({
                            value: e
                        }) => de(e) ? `${e}%` : null,
                        handle: e => [s(), y("--tw-backdrop-saturate", `saturate(${e})`), y("-webkit-backdrop-filter", i), y("backdrop-filter", i)]
                    }), r("saturate", (() => [{
                        ...
                        defaultValue: "100%",
                        handle: e => [l(), y("--tw-sepia", `sepia(${e})`), y("filter", a)]
                    }), o("backdrop-sepia", {
                        ...
                        defaultValue: "100%",
                        handle: e => [s(), y("--tw-backdrop-sepia", `sepia(${e})`), y("-webkit-backdrop-filter", i), y("backdrop-filter", i)]
                    }), r("sepia", (() => [{
                        values: ["0", "50", "100"],
                        ...
                        let r;
                        if (t.modifier && ("arbitrary" === t.modifier.kind ? r = t.modifier.value : de(t.modifier.value) && (r = `${t.modifier.value}%`)), !t.value) {
                            let t = e.get(["--drop-shadow"]);
                            return null === t ? void 0 : [l(), y("--tw-drop-shadow-alpha", r), ...Ke("--tw-drop-shadow-size", t, r, (e => `var(--tw-drop-shadow-color, ${e})`)), y("--tw-drop-shadow", `drop-shadow(${e.resolve(null,["--drop-shadow"])})`), y("filter", a)]
                        }
                        if ("arbitrary" === t.value.kind) {
                            let n = t.value.value;
                            return "color" === (t.value.dataType ?? G(n, ["color"])) ? (n = Ce(n, t.modifier, e), null === n ? void 0 : [l(), y("--tw-drop-shadow-color", ze(n, "var(--tw-drop-shadow-alpha)")), y("--tw-drop-shadow", "var(--tw-drop-shadow-size)")]) : t.modifier && !r ? void 0 : [l(), y("--tw-drop-shadow-alpha", r), ...Ke("--tw-drop-shadow-size", n, r, (e => `var(--tw-drop-shadow-color, ${e})`)), y("--tw-drop-shadow", "var(--tw-drop-shadow-size)"), y("filter", a)]
                        } {
                            let n = e.get([`--drop-shadow-${t.value.value}`]);
                            if (n) return t.modifier && !r ? void 0 : r ? [l(), y("--tw-drop-shadow-alpha", r), ...Ke("--tw-drop-shadow-size", n, r, (e => `var(--tw-drop-shadow-color, ${e})`)), y("--tw-drop-shadow", "var(--tw-drop-shadow-size)"), y("filter", a)] : [l(), y("--tw-drop-shadow-alpha", r), ...Ke("--tw-drop-shadow-size", n, r, (e => `var(--tw-drop-shadow-color, ${e})`)), y("--tw-drop-shadow", `drop-shadow(${e.resolve(t.value.value,["--drop-shadow"])})`), y("filter", a)]
                        } {
                            let r = Te(t, e, ["--drop-shadow-color", "--color"]);
                            if (r) return [l(), y("--tw-drop-shadow-color", ze(r, "var(--tw-drop-shadow-alpha)")), y("--tw-drop-shadow", "var(--tw-drop-shadow-size)")]
                        }
                    })), r("drop-shadow", (() => [{
                        values: ["current", "inherit", "transparent"],
                        ...
                        handle: e => [s(), y("--tw-backdrop-opacity", `opacity(${e})`), y("-webkit-backdrop-filter", i), y("backdrop-filter", i)]
                    }), r("backdrop-opacity", (() => [{
                        values: Array.from({
                            length: 21
                        }, ((e, t) => "" + 5 * t)),
                    ...
                    n("transition-none", [
                        ...
                        handle: e => [y("transition-property", e), y("transition-timing-function", a), y("transition-duration", i)]
                    ...
                    });
                    {
                        ...
                        n("duration-initial", [r, ["--tw-duration", "initial"]]), t.functional("duration", (t => {
                            ...
                            let n = null;
                            return "arbitrary" === t.value.kind ? n = t.value.value : (n = e.resolve(t.value.fraction ?? t.value.value, ["--transition-duration"]), null === n && de(t.value.value) && (n = `${t.value.value}ms`)), null !== n ? [r(), y("--tw-duration", n), y("transition-duration", n)] : void 0
                        }))
                    }
                    r("delay", (() => [{
                ...
                n("will-change-auto", [
                    ...
                    themeKeys: [],
                    handle: e => [z([$e("--tw-content", '""')]), y("--tw-content", e), y("content", "var(--tw-content)")]
                });
                {
                    let e = "var(--tw-contain-size,) var(--tw-contain-layout,) var(--tw-contain-paint,) var(--tw-contain-style,)",
                        t = () => z([$e("--tw-contain-size"), $e("--tw-contain-layout"), $e("--tw-contain-paint"), $e("--tw-contain-style")]);
                    n("contain-none", [
                        ["contain", "none"]
                    ]), n("contain-content", [
                        ["contain", "content"]
                ...
                ]), n("leading-none", [() => z([$e("--tw-leading")]), ["--tw-leading", "1"],
                    ["line-height", "1"]
                ]), i("leading", ["--leading", "--spacing"], (e => [z([$e("--tw-leading")]), y("--tw-leading", e), y("line-height", e)])), o("tracking", {
                    supportsNegative: !0,
                    themeKeys: ["--tracking"],
                    handle: e => [z([$e("--tw-tracking")]), y("--tw-tracking", e), y("letter-spacing", e)]
                }), n("antialiased", [
                ...
                ]);
                {
                    let e = "var(--tw-ordinal,) var(--tw-slashed-zero,) var(--tw-numeric-figure,) var(--tw-numeric-spacing,) var(--tw-numeric-fraction,)",
                        t = () => z([$e("--tw-ordinal"), $e("--tw-slashed-zero"), $e("--tw-numeric-figure"), $e("--tw-numeric-spacing"), $e("--tw-numeric-fraction")]);
                    n("normal-nums", [
                    ...
                    t.static("outline-hidden", (() => [y("--tw-outline-style", "none"), y("outline-style", "none"), k("@media", "(forced-colors: active)", [y("outline", "2px solid transparent"), y("outline-offset", "2px")])])), n("outline-none", [
                        ...
                        if (null === t.value) {
                            ...
                            return [a(), y("outline-style", "var(--tw-outline-style)"), y("outline-width", r)]
                        }
                        if ("arbitrary" === t.value.kind) {
                            let r = t.value.value;
                            switch (t.value.dataType ?? G(r, ["color", "length", "number", "percentage"])) {
                                case "length":
                                case "number":
                                case "percentage":
                                    return t.modifier ? void 0 : [a(), y("outline-style", "var(--tw-outline-style)"), y("outline-width", r)];
                                default:
                                    return r = Ce(r, t.modifier, e), null === r ? void 0 : [y("outline-color", r)]
                            }
                        } {
                            ...
                            if (r) return [a(), y("outline-style", "var(--tw-outline-style)"), y("outline-width", r)];
                            if (de(t.value.value)) return [a(), y("outline-style", "var(--tw-outline-style)"), y("outline-width", `${t.value.value}px`)]
                        }
                    })), r("outline", (() => [{
                        values: ["current", "inherit", "transparent"],
                ...
                o("opacity", {
                    ...
                    if (t.value) {
                        if ("arbitrary" === t.value.kind) {
                            let r = t.value.value;
                            switch (t.value.dataType ?? G(r, ["color", "length", "percentage", "absolute-size", "relative-size"])) {
                                case "size":
                                case "length":
                                case "percentage":
                                case "absolute-size":
                                ...
                                default:
                                    return r = Ce(r, t.modifier, e), null === r ? void 0 : [y("color", r)]
                            }
                        } {
                ...
                let j = () => z([$e("--tw-text-shadow-color"), $e("--tw-text-shadow-alpha", "100%", "<percentage>")]);
                n("text-shadow-initial", [j, ["--tw-text-shadow-color", "initial"]]), t.functional("text-shadow", (t => {
                    let r;
                    if (t.modifier && ("arbitrary" === t.modifier.kind ? r = t.modifier.value : de(t.modifier.value) && (r = `${t.modifier.value}%`)), !t.value) {
                        let t = e.get(["--text-shadow"]);
                        return null === t ? void 0 : [j(), y("--tw-text-shadow-alpha", r), ...Se("text-shadow", t, r, (e => `var(--tw-text-shadow-color, ${e})`))]
                    }
                    if ("arbitrary" === t.value.kind) {
                        let n = t.value.value;
                        return "color" === (t.value.dataType ?? G(n, ["color"])) ? (n = Ce(n, t.modifier, e), null === n ? void 0 : [j(), y("--tw-text-shadow-color", ze(n, "var(--tw-text-shadow-alpha)"))]) : [j(), y("--tw-text-shadow-alpha", r), ...Se("text-shadow", n, r, (e => `var(--tw-text-shadow-color, ${e})`))]
                    }
                    if ("none" === t.value.value) return t.modifier ? void 0 : [j(), y("text-shadow", "none")];
                    {
                        let n = e.get([`--text-shadow-${t.value.value}`]);
                        if (n) return [j(), y("--tw-text-shadow-alpha", r), ...Se("text-shadow", n, r, (e => `var(--tw-text-shadow-color, ${e})`))]
                    } {
                        let r = Te(t, e, ["--text-shadow-color", "--color"]);
                        if (r) return [j(), y("--tw-text-shadow-color", ze(r, "var(--tw-text-shadow-alpha)"))]
                    }
                })), r("text-shadow", (() => [{
                    values: ["current", "inherit", "transparent"],
                ...
                }]));
                {
                    let o = function(e) {
                        ...
                        i = ["var(--tw-inset-shadow)", "var(--tw-inset-ring-shadow)", "var(--tw-ring-offset-shadow)", "var(--tw-ring-shadow)", "var(--tw-shadow)"].join(", "),
                        l = "0 0 #0000",
                        s = () => z([$e("--tw-shadow", l), $e("--tw-shadow-color"), $e("--tw-shadow-alpha", "100%", "<percentage>"), $e("--tw-inset-shadow", l), $e("--tw-inset-shadow-color"), $e("--tw-inset-shadow-alpha", "100%", "<percentage>"), $e("--tw-ring-color"), $e("--tw-ring-shadow", l), $e("--tw-inset-ring-color"), $e("--tw-inset-ring-shadow", l), $e("--tw-ring-inset"), $e("--tw-ring-offset-width", "0px", "<length>"), $e("--tw-ring-offset-color", "#fff"), $e("--tw-ring-offset-shadow", l)]);
                    n("shadow-initial", [s, ["--tw-shadow-color", "initial"]]), t.functional("shadow", (t => {
                        let r;
                        if (t.modifier && ("arbitrary" === t.modifier.kind ? r = t.modifier.value : de(t.modifier.value) && (r = `${t.modifier.value}%`)), !t.value) {
                            let t = e.get(["--shadow"]);
                            return null === t ? void 0 : [s(), y("--tw-shadow-alpha", r), ...Se("--tw-shadow", t, r, (e => `var(--tw-shadow-color, ${e})`)), y("box-shadow", i)]
                        }
                        if ("arbitrary" === t.value.kind) {
                            let n = t.value.value;
                            return "color" === (t.value.dataType ?? G(n, ["color"])) ? (n = Ce(n, t.modifier, e), null === n ? void 0 : [s(), y("--tw-shadow-color", ze(n, "var(--tw-shadow-alpha)"))]) : [s(), y("--tw-shadow-alpha", r), ...Se("--tw-shadow", n, r, (e => `var(--tw-shadow-color, ${e})`)), y("box-shadow", i)]
                        }
                        if ("none" === t.value.value) return t.modifier ? void 0 : [s(), y("--tw-shadow", l), y("box-shadow", i)];
                        {
                            let n = e.get([`--shadow-${t.value.value}`]);
                            if (n) return [s(), y("--tw-shadow-alpha", r), ...Se("--tw-shadow", n, r, (e => `var(--tw-shadow-color, ${e})`)), y("box-shadow", i)]
                        } {
                            let r = Te(t, e, ["--box-shadow-color", "--color"]);
                            if (r) return [s(), y("--tw-shadow-color", ze(r, "var(--tw-shadow-alpha)"))]
                        }
                    })), r("shadow", (() => [{
                        values: ["current", "inherit", "transparent"],
                        ...
                        if (t.modifier && ("arbitrary" === t.modifier.kind ? r = t.modifier.value : de(t.modifier.value) && (r = `${t.modifier.value}%`)), !t.value) {
                            ...
                            return null === t ? void 0 : [s(), y("--tw-inset-shadow-alpha", r), ...Se("--tw-inset-shadow", t, r, (e => `var(--tw-inset-shadow-color, ${e})`)), y("box-shadow", i)]
                        }
                        if ("arbitrary" === t.value.kind) {
                            let n = t.value.value;
                            return "color" === (t.value.dataType ?? G(n, ["color"])) ? (n = Ce(n, t.modifier, e), null === n ? void 0 : [s(), y("--tw-inset-shadow-color", ze(n, "var(--tw-inset-shadow-alpha)"))]) : [s(), y("--tw-inset-shadow-alpha", r), ...Se("--tw-inset-shadow", n, r, (e => `var(--tw-inset-shadow-color, ${e})`), "inset "), y("box-shadow", i)]
                        }
                        if ("none" === t.value.value) return t.modifier ? void 0 : [s(), y("--tw-inset-shadow", l), y("box-shadow", i)];
                        {
                            let n = e.get([`--inset-shadow-${t.value.value}`]);
                            if (n) return [s(), y("--tw-inset-shadow-alpha", r), ...Se("--tw-inset-shadow", n, r, (e => `var(--tw-inset-shadow-color, ${e})`)), y("box-shadow", i)]
                        } {
                            let r = Te(t, e, ["--box-shadow-color", "--color"]);
                            if (r) return [s(), y("--tw-inset-shadow-color", ze(r, "var(--tw-inset-shadow-alpha)"))]
                        }
                    })), r("inset-shadow", (() => [{
                        values: ["current", "inherit", "transparent"],
                        valueThemeKeys: ["--box-shadow-color", "--color"],
                    ...
                    t.functional("ring", (t => {
                        ...
                        if ("arbitrary" === t.value.kind) {
                            let r = t.value.value;
                            return "length" === (t.value.dataType ?? G(r, ["color", "length"])) ? t.modifier ? void 0 : [s(), y("--tw-ring-shadow", o(r)), y("box-shadow", i)] : (r = Ce(r, t.modifier, e), null === r ? void 0 : [y("--tw-ring-color", r)])
                        } {
                            ...
                            if (null === r && de(t.value.value) && (r = `${t.value.value}px`), r) return [s(), y("--tw-ring-shadow", o(r)), y("box-shadow", i)]
                        }
                    })), r("ring", (() => [{
                        values: ["current", "inherit", "transparent"],
                        ...
                        if (!t.value) return t.modifier ? void 0 : [s(), y("--tw-inset-ring-shadow", a("1px")), y("box-shadow", i)];
                        if ("arbitrary" === t.value.kind) {
                            let r = t.value.value;
                            return "length" === (t.value.dataType ?? G(r, ["color", "length"])) ? t.modifier ? void 0 : [s(), y("--tw-inset-ring-shadow", a(r)), y("box-shadow", i)] : (r = Ce(r, t.modifier, e), null === r ? void 0 : [y("--tw-inset-ring-color", r)])
                        } {
                            let r = Te(t, e, ["--ring-color", "--color"]);
                            ...
                            if (t.modifier) return;
                            let r = e.resolve(t.value.value, ["--ring-width"]);
                            if (null === r && de(t.value.value) && (r = `${t.value.value}px`), r) return [s(), y("--tw-inset-ring-shadow", a(r)), y("box-shadow", i)]
                        }
                    })), r("inset-ring", (() => [{
                        values: ["current", "inherit", "transparent"],
                        valueThemeKeys: ["--ring-color", "--color"],
                    ...
                    t.functional("ring-offset", (t => {
                        if (t.value) {
                            if ("arbitrary" === t.value.kind) {
                                let r = t.value.value;
                                return "length" === (t.value.dataType ?? G(r, ["color", "length"])) ? t.modifier ? void 0 : [y("--tw-ring-offset-width", r), y("--tw-ring-offset-shadow", u)] : (r = Ce(r, t.modifier, e), null === r ? void 0 : [y("--tw-ring-offset-color", r)])
                            } {
                                ...
                                if (de(t.value.value)) return t.modifier ? void 0 : [y("--tw-ring-offset-width", `${t.value.value}px`), y("--tw-ring-offset-shadow", u)]
                            } {
            ...
            r = function(e) {
                ...
                function a(e) {
                    for (let t of o) {
                        ...
                        let r = R(e.params, ",");
                        return r.length > 1 ? null : (r = n(e.name, r), k(e.name, r.join(", ")))
                    }
                    return null
                }

                function i(e) {
                    return e.includes("::") ? null : `&:not(${R(e,",").map((e=>e.replaceAll("&","*"))).join(", ")})`
                }
                t.compound("not", 3, ((e, t) => {
                    ...
                    return A([t], ((e, {
                        ...
                        R(r, ",").length > 1 && (r = `:is(${r})`), e.selector = `&:is(${r} *)`, o = !0
                    })), o ? void 0 : null
                ...
                })), t.suggest("peer", (() => Array.from(t.keys()).filter((e => t.compoundsWith("peer", e))))), r("first-letter", ["&::first-letter"]), r("first-line", ["&::first-line"]), r("marker", ["& *::marker", "&::marker", "& *::-webkit-details-marker", "&::-webkit-details-marker"]), r("selection", ["& *::selection", "&::selection"]), r("file", ["&::file-selector-button"]), r("placeholder", ["&::placeholder"]), r("backdrop", ["&::backdrop"]), r("details-content", ["&::details-content"]);
                {
                    ...
                    t.static("before", (t => {
                        t.nodes = [w("&::before", [e(), y("content", "var(--tw-content)"), ...t.nodes])]
                    }), {
                        compounds: 0
                    }), t.static("after", (t => {
                        t.nodes = [w("&::after", [e(), y("content", "var(--tw-content)"), ...t.nodes])]
                    }), {
                        compounds: 0
                    })
                }
                r("first", ["&:first-child"]), r("last", ["&:last-child"]), r("only", ["&:only-child"]), r("odd", ["&:nth-child(odd)"]), r("even", ["&:nth-child(even)"]), r("first-of-type", ["&:first-of-type"]), r("last-of-type", ["&:last-of-type"]), r("only-of-type", ["&:only-of-type"]), r("visited", ["&:visited"]), r("target", ["&:target"]), r("open", ["&:is([open], :popover-open, :open)"]), r("default", ["&:default"]), r("checked", ["&:checked"]), r("indeterminate", ["&:indeterminate"]), r("placeholder-shown", ["&:placeholder-shown"]), r("autofill", ["&:autofill"]), r("optional", ["&:optional"]), r("required", ["&:required"]), r("valid", ["&:valid"]), r("invalid", ["&:invalid"]), r("user-valid", ["&:user-valid"]), r("user-invalid", ["&:user-invalid"]), r("in-range", ["&:in-range"]), r("out-of-range", ["&:out-of-range"]), r("read-only", ["&:read-only"]), r("empty", ["&:empty"]), r("focus-within", ["&:focus-within"]), t.static("hover", (e => {
                    ...
                    "arbitrary" === t.value.kind ? e.nodes = [w(`&[aria-${Me(t.value.value)}]`, e.nodes)] : e.nodes = [w(`&[aria-${t.value.value}="true"]`, e.nodes)]
                })), t.suggest("aria", (() => ["busy", "checked", "disabled", "expanded", "hidden", "pressed", "readonly", "required", "selected"])), t.functional("data", ((e, t) => {
                    if (!t.value || t.modifier) return null;
                    e.nodes = [w(`&[data-${Me(t.value.value)}]`, e.nodes)]
                    ...
                    } else r.includes(":") || (r = `${r}: var(--tw)`), ("(" !== r[0] || ")" !== r[r.length - 1]) && (r = `(${r})`), e.nodes = [k("@supports", r, e.nodes)]
                }), {
                    compounds: 1
                    ...
                    };
                    {
                        ...
                        t.group((() => {
                            t.functional("@max", ((e, t) => {
                                let r = o.get(t);
                                if (null === r) return null;
                                e.nodes = [k("@container", t.modifier ? `${t.modifier.value} (width < ${r})` : `(width < ${r})`, e.nodes)]
                            }), {
                                compounds: 1
                            })
                        }), ((e, t) => r(e, t, "desc", o))), t.suggest("@max", (() => Array.from(n.keys()).filter((e => null !== e)))), t.group((() => {
            ...
            n = new c((e => function(e, t) {
                if ("[" === e[0] && "]" === e[e.length - 1]) {
                    ...
                    for (let [e, r] of a) switch (t.variants.kind(e)) {
                        case "static":
                        ...
                        case "functional": {
                            ...
                            if (")" === r[r.length - 1]) {
                                if ("(" !== r[0]) continue;
                                let n = W(r.slice(1, -1));
                                return !M(n) || 0 === n.length || 0 === n.trim().length || "-" !== n[0] && "-" !== n[1] ? null : {
                                    kind: "functional",
                                    root: e,
                                    modifier: t,
                                    value: {
            ...
            a = new c((e => Array.from(function*(e, t) {
                let r = R(e, ":");
                if (t.theme.prefix) {
                ...
                let a = !1;
                "!" === n[n.length - 1] ? (a = !0, n = n.slice(0, -1)) : "!" === n[0] && (a = !0, n = n.slice(1)), t.utilities.has(n, "static") && !n.includes("[") && (yield {
                    kind: "static",
                    root: n,
                    variants: o,
                    important: a,
                    ...
                    if ("[" !== i[0]) {
                        if ("]" === i[i.length - 1]) {
                            ...
                            let n = i.slice(e + 2, -1),
                                o = R(n, ":"),
                                a = null;
                            if (2 === o.length && (a = o[0], n = o[1]), "-" !== n[0] && "-" !== n[1]) return;
                            c = [
                                [r, null === a ? `[var(${n})]` : `[${a}:var(${n})]`]
                            ]
            ...
            i = new c((e => {
                let t = function(e, t) {
                    let r = function(e, t) {
                        if ("arbitrary" === e.kind) {
                            let r = e.value;
                            return e.modifier && (r = Ce(r, e.modifier, t.theme)), null === r ? [] : [
                                [y(e.property, r)]
                            ]
                        }
            ...
            s = {
                ...
                candidatesToCss(e) {
                    ...
                    for (let r of e) {
                        ...
                        n = T(n, s, 0), 0 === n.length || e ? t.push(null) : t.push(j(n))
                    }
                    return t
                },
                getClassOrder(e) {
                    return function(e, t) {
                        let {
                            astNodes: r,
                            nodeSorting: n
                        } = qe(Array.from(t), e), o = new Map(t.map((e => [e, null]))), a = 0n;
                        for (let e of r) {
    ...
    function qe(e, t, {
        ...
        return o.sort(((e, t) => {
            ...
            return (r.properties.order[a] ?? 1 / 0) - (o.properties.order[a] ?? 1 / 0) || o.properties.count - r.properties.count || Fe(r.candidate, o.candidate)
        })), {
            astNodes: o,
            nodeSorting: n
        }
    ...
    function Pe(e, t, r, n = 0) {
        ...
        if ("compound" === t.kind) {
            let a = k("@slot");
            if (null === Pe(a, t.variant, r, n + 1) || "not" === t.root && a.nodes.length > 1) return null;
    ...
    function Ye(e) {
        for (let t of e) "at-root" !== t.kind && ("declaration" === t.kind ? t.important = !0 : ("rule" === t.kind || "at-rule" === t.kind) && Ye(t.nodes))
    }
    ...
    function Ze(e) {
        ...
        for (; n.length > 0;) {
            ...
            if ("declaration" === e.kind) {
                ...
                let n = Ie.indexOf(e.property); - 1 !== n && t.add(n)
        ...
        function d(e, r = []) {
            if (!l.has(e)) {
                if (u.has(e)) {
                    ...
                    throw "at-rule" === e.kind && "@utility" === e.name && "at-rule" === n.kind && "@utility" === n.name && A(e.nodes, (e => {
                        ...
                        for (let e of r)
                            for (let r of t.parseCandidate(e)) switch (r.kind) {
                                ...
                                case "static":
                                case "functional":
                                    if (n.params.replace(/-\*$/, "") === r.root) throw new Error(`You cannot \`
                                        @apply` the \`
                                        $ {
                                            e
                                        }\
    ...
    async function Je(e, r, n, o = 0) {
        ...
        return A(e, ((e, {
            ...
            if ("at-rule" === e.kind && ("@import" === e.name || "@reference" === e.name)) {
                ...
                let p = $({}, []);
                return i.push((async () => {
                    if (o > 100) throw new Error(`Exceeded maximum recursion depth while resolving \`
                        $ {
                            c
                        }\
                        ` in \`
                    ...
                    let e = await n(c, r),
                        a = t(e.content);
                    await Je(a, e.base, n, o + 1), p.nodes = function(e, t, r, n) {
                        let o = e;
                        return null !== t && (o = [k("@layer", t, o)]), null !== r && (o = [k("@media", r, o)]), null !== n && (o = [k("@supports", "(" === n[0] ? n : `(${n})`, o)]), o
                    }([$({
                        base: e.base
                    }, a)], u, d, f)
                })()), l(p), 1
            }
        })), i.length > 0 && await Promise.all(i), a
    }
    ...
    function et(e, {
        ...
        if (Object.hasOwn(t, "fontFamily")) {
            let r = 5;
            {
                ...
                n && e.theme.hasDefault("--font-sans") && (e.theme.add("--default-font-family", n, r), e.theme.add("--default-font-feature-settings", Qe(t.fontFamily.sans, "fontFeatureSettings") ?? "normal", r), e.theme.add("--default-font-variation-settings", Qe(t.fontFamily.sans, "fontVariationSettings") ?? "normal", r))
            } {
                let n = Qe(t.fontFamily.mono);
                n && e.theme.hasDefault("--font-mono") && (e.theme.add("--default-mono-font-family", n, r), e.theme.add("--default-mono-font-feature-settings", Qe(t.fontFamily.mono, "fontFeatureSettings") ?? "normal", r), e.theme.add("--default-mono-font-variation-settings", Qe(t.fontFamily.mono, "fontVariationSettings") ?? "normal", r))
            }
        }
        return t
    }
    ...
    function nt(e, t = [], r) {
        for (let n of Reflect.ownKeys(e)) {
            ...
            if (1 !== i) {
                if (2 === i) return 2;
                if ((Array.isArray(o) || "object" == typeof o) && 2 === nt(o, a, r)) return 2
            }
        }
    }
        ...
        for (let o of t)
            if (null != o)
                for (let t of Reflect.ownKeys(o)) {
                    n.push(t);
                    let a = r(e[t], o[t], n);
                    void 0 !== a ? e[t] = a : at(e[t]) && at(o[t]) ? e[t] = it({}, [e[t], o[t]], r, n) : e[t] = o[t], n.pop()
                }
        return e
    }
    ...
    function lt(e, t, r) {
        return function(n, o) {
            let i = n.lastIndexOf("/"),
                l = null; - 1 !== i && (l = n.slice(i + 1).trim(), n = n.slice(0, i).trim());
            let s = (() => {
                let o = ot(n),
                    [i, l] = function(e, t) {
                ...
                if (null !== s && "object" == typeof s && !Array.isArray(s)) {
                    ...
                    for (let t in i) "__CSS_VALUES__" !== t && (4 & s?.__CSS_VALUES__?.[t] && void 0 !== st(e, t.split("-")) || (e[a(t)] = i[t]));
                    return e
                }
        ...
        for (let n = 0; n < e.length; n++) {
            let o = e[n],
                ...
                l = t(o, {
                    parent: r,
                    replaceWith(t) {
                        a || (a = !0, Array.isArray(t) ? 0 === t.length ? (e.splice(n, 1), i = 0) : 1 === t.length ? (e[n] = t[0], i = 1) : (e.splice(n, 1, ...t), i = t.length) : (e[n] = t, i = 1))
                    }
                }) ?? 0;
            if (a) 0 === l ? n-- : n += i - 1;
            else {
                if (2 === l) return 2;
                if (1 !== l && "function" === o.kind && 2 === mt(o.nodes, t, o)) return 2
            }
        }
    }
            ...
            switch (l) {
                ...
                case 40: {
                    ...
                    if (a = "", ":not" !== l.value && ":where" !== l.value && ":has" !== l.value && ":is" !== l.value) {
                        ...
                        let c = i;
                        l.nodes.push(ht(e.slice(n, c))), a = "", i = c, o ? o.nodes.push(l) : r.push(l);
                        break
                    }
            ...
            addUtilities(r) {
                ...
                for (let [e, r] of a) {
                    ...
                    let n = vt(e),
                        a = !1;
                    if (mt(n, (e => {
                            if ("selector" === e.kind && "." === e.value[0] && wt.test(e.value.slice(1))) {
                                let t = e.value;
                                e.value = "&";
                                let o = gt(n),
                                    l = t.slice(1),
                        ...
                        addUtilities({
                            '${e}': …
                        })` defines an invalid utility selector. Utilities must be a single class name and start with a lowercase letter, eg. \`.scrollbar - none`.`)
                }
                for (let [t, r] of i) e.theme.prefix && A(r, (t => {
                    if ("rule" === t.kind) {
                        let r = vt(t.selector);
                        mt(r, (t => {
            ...
            matchUtilities(t, r) {
                ...
                for (let [a, i] of Object.entries(t)) {
                    let t = function({
                        ...
                        return l => {
                            if ("arbitrary" === l.value?.kind && o.length > 0 && !o.includes("any") && (l.value.dataType && !o.includes(l.value.dataType) || !l.value.dataType && !G(l.value.value, o))) return;
                    ...
                    if (!wt.test(a)) throw new Error(`\`
                        matchUtilities({
                            '${a}': …
                        })` defines an invalid utility name. Utilities should be alphanumeric and start with a lowercase letter, eg. \`
                        scrollbar`.`);
                    r?.supportsNegativeValues && e.utilities.functional(`-${a}`, t({
                        negative: !0
                    }), {
                        types: o
    ...
    function bt(e) {
        ...
        for (let [e, n] of r)
            ...
            for (let r of n) "string" == typeof r ? t.push(y(e, r)) : t.push(b(e, bt(r)));
    ...
    function $t(e, t, r) {
        for (let r of function(e) {
                ...
                if ("keyframes" in e.theme)
                    for (let [r, n] of Object.entries(e.theme.keyframes)) t.push(k("@keyframes", r, bt(n)));
                return t
    ...
    function Ut(e, t) {
        return Array.isArray(e) && at(e[0]) ? e.concat(t) : Array.isArray(t) && at(t[0]) && at(e) ? [e, ...t] : Array.isArray(t) ? t : void 0
    }
    ...
    function Dt(e, {
        ...
        let a = [];
        for (let e of t.plugins ?? []) "__isOptionsFunction" in e ? a.push({
            ...e(),
            reference: o
        }) : "handler" in e ? a.push({
            ...e,
        ...
        for (let a of t.presets ?? []) Dt(e, {
            path: n,
            base: r,
            config: a,
            reference: o
        });
        for (let t of a) e.plugins.push(t), t.config && Dt(e, {
            path: n,
            base: r,
            config: t.config,
        ...
        for (let t of l) e.content.files.push("object" == typeof t ? t : {
            base: r,
            pattern: t
        });
        e.configs.push(t)
        ...
        let n = function({
            ...
            if (e && o.push(y("margin-inline", "auto")), ("string" == typeof t || "object" == typeof t && null !== t && "DEFAULT" in t) && o.push(y("padding-inline", "string" == typeof t ? t : t.DEFAULT)), "object" == typeof r && null !== r) {
                ...
                if (e.sort(((e, t) => P(e[1], t[1], "asc"))), e.length > 0) {
                    let [t] = e[0];
                    o.push(k("@media", `(width >= --theme(--breakpoint-${t}))`, [y("max-width", "none")]))
                }
            ...
            if ("object" == typeof t && null !== t) {
                ...
                for (let [t, , r] of e)
                    if (a && a.has(t)) a.get(t).nodes.push(y("padding-inline", r));
                        ...
                        if (a) continue;
                        o.push(k("@media", `(width >= theme(--breakpoint-${t}))`, [y("padding-inline", r)]))
                    }
            }
            if (a)
    ...
    async function Rt({
        ...
        A(r, ((e, {
                ...
                if ("at-rule" === e.kind) {
                    if ("@plugin" === e.name) {
                        ...
                        let l = {};
                        for (let t of e.nodes ?? []) {
                            if ("declaration" !== t.kind) throw new Error(`Unexpected \`
                                @plugin` option:\n\n${j([t])}\n\n\`
                            ...
                            let e = R(t.value, ",").map((e => {
                                ...
                                if ("{" === e[0] && "}" === e[e.length - 1]) throw new Error(`Unexpected \`
                                    @plugin` option: Value of declaration \`
                                    $ {
                                        j([t]).trim()
                                    }\
                        ...
                        }, Object.keys(l).length > 0 ? l : null]), r([]), void(a |= 4)
                    }
                    if ("@config" === e.name) {
            ...
            function(e) {
                ...
                e.utilities.static("bg-left-top", (() => [y("background-position", "left top")])), e.utilities.static("bg-right-top", (() => [y("background-position", "right top")])), e.utilities.static("bg-left-bottom", (() => [y("background-position", "left bottom")])), e.utilities.static("bg-right-bottom", (() => [y("background-position", "right bottom")])), e.utilities.static("object-left-top", (() => [y("object-position", "left top")])), e.utilities.static("object-right-top", (() => [y("object-position", "right top")])), e.utilities.static("object-left-bottom", (() => [y("object-position", "left bottom")])), e.utilities.static("object-right-bottom", (() => [y("object-position", "right bottom")])), e.utilities.functional("max-w-screen", (t => {
        ...
        if (e.resolveThemeValue = function(n, i) {
                return n.startsWith("--") ? s(n, i) : (a |= It({
                    designSystem: e,
                    base: t,
                    ast: r,
                    sources: o,
            ...
            }, !i.length && !l.length) return 0;
        let [c, u] = await Promise.all([Promise.all(l.map((async ({
            id: e,
            base: t,
            reference: r
        }) => {
    ...
    function It({
        ...
        if (et(e, c, u), $t(e, c), function(e, t) {
                let r = e.theme.aria || {},
                    n = e.theme.supports || {},
                    o = e.theme.data || {};
            ...
            }(c, e), Bt(c, e), !e.theme.prefix && s.prefix) {
            if (s.prefix.endsWith("-") && (s.prefix = s.prefix.slice(0, -1), console.warn(`The prefix "${s.prefix}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only and is written as a variant before all utilities. We have fixed up the prefix for you. Remove the trailing \` - \` to silence this warning.`)), !Lt.test(s.prefix)) throw new Error(`The prefix "${s.prefix}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only.`);
        ...
        if (!e.important && !0 === s.important && (e.important = !0), "string" == typeof s.important) {
            ...
            A(r, ((t, {
                ...
                if ("at-rule" === t.kind && "@tailwind" === t.name && "utilities" === t.params) return "rule" === n?.kind && n.selector === e || r(w(e, [t])), 2
            }))
        }
        for (let t of s.blocklist) e.invalidCandidates.add(t);
        for (let e of s.content.files) {
            if ("raw" in e) throw new Error(`Error in the config file/plugin/preset. The \`
                content` key contains a \`
                raw` entry:\n\n${JSON.stringify(e,null,2)}\n\nThis feature is not currently supported.`);
            let t = !1;
            "!" == e.pattern[0] && (t = !0, e.pattern = e.pattern.slice(1)), n.push({
                ...e,
                negated: t
            })
        }
    ...
    function Pt(e) {
        ...
        if (-1 === i) throw new Error(`The pattern \`
            $ {
                e
            }\
            ` is not balanced.`);
        ...
        l = function(e) {
            ...
            let t = e.match(qt);
            if (!t) return [e];
            let [, r, n, o] = t, a = o ? parseInt(o, 10) : void 0, i = [];
            if (/^-?\d+$/.test(r) && /^-?\d+$/.test(n)) {
                let e = parseInt(r, 10),
                    t = parseInt(n, 10);
                if (void 0 === a && (a = e <= t ? 1 : -1), 0 === a) throw new Error("Step cannot be zero in sequence expansion.");
                if (a > 0)
                    for (let r = e; r <= t; r += a) {
                        let e = r.toString();
                        i.push(e)
            ...
            return i
        }(s) : R(s, ","), l = l.flatMap((e => Pt(e)));
        let u = Pt(c);
        for (let e of u)
            for (let t of l) r.push(n + t + e);
        return r
    }
    var Ht = /^[a-z]+$/;
        ...
        A(e, ((e, {
            ...
            if ("at-rule" === e.kind) {
                ...
                if ("@utility" === e.name) {
                    ...
                    if (0 === e.nodes.length) throw new Error(`\`
                        @utility $ {
                            e.params
                        }\
                        ` is empty. Utilities should include at least one property.`);
                    let r = function(e) {
                        let t = e.params;
                        return be.test(t) ? r => {
                            let n = {
                            ...
                            A(e.nodes, (e => {
                                ...
                                p(t, (e => {
                                    ...
                                    if (!("--spacing" !== e.value || n["--modifier"].usedSpacingNumber && n["--value"].usedSpacingNumber)) return p(e.nodes, (e => {
                                        ...
                                        0 === (p(f, ((f, {
                                            ...
                                            if ("function" === f.kind) {
                                                if ("--value" === f.value) {
                                                    i = !0;
                                                    let a = je(o, f, r);
                                                    return a ? (l = !0, a.ratio ? d = !0 : u.set(e, t), p(a.nodes), 1) : (i ||= !1, n([]), 2)
                                                }
                                                if ("--modifier" === f.value) {
                    ...
                    if (null === r) throw new Error(`\`
                        ...
                        ` defines an invalid utility name. Utilities should be alphanumeric and start with a lowercase letter.`);
                    d.push(r)
                }
                if ("@source" === e.name) {
                    ...
                    let o = !1,
                        a = !1,
                        i = e.params;
                    if ("n" === i[0] && i.startsWith("not ") && (o = !0, i = i.slice(4)), "i" === i[0] && i.startsWith("inline(") && (a = !0, i = i.slice(7, -1)), '"' === i[0] && '"' !== i[i.length - 1] || "'" === i[0] && "'" !== i[i.length - 1] || "'" !== i[0] && '"' !== i[0]) throw new Error("`@source` paths must be quoted.");
                    let l = i.slice(1, -1);
                    if (a) {
                        let e = o ? T : C,
                            t = R(l, " ");
                        for (let r of t)
                            for (let t of Pt(r)) e.push(t)
                    } else x.push({
                        base: n.base,
                        pattern: l,
                        negated: o
                ...
                if ("@variant" === e.name && (null === t ? 0 === e.nodes.length ? e.name = "@custom-variant" : (A(e.nodes, (t => {
                    ...
                    r([]);
                    let [n, o] = R(e.params, " ");
                    if (!De.test(n)) throw new Error(`\`
                        @custom - variant $ {
                            n
                        }\
                        ` defines an invalid variant name. Variants should only contain alphanumeric, dashes or underscore characters.`);
                    if (e.nodes.length > 0 && o) throw new Error(`\`
                        @custom - variant $ {
                            n
                        }\
                        ` cannot have both a selector and a body.`);
                    if (0 === e.nodes.length) {
                        if (!o) throw new Error(`\`
                            @custom - variant $ {
                                n
                            }\
                            ` has no selector or body.`);
                        let e = R(o.slice(1, -1), ",");
                        if (0 === e.length || e.some((e => "" === e.trim()))) throw new Error(`\`
                            @custom - variant $ {
                                n
                            }($ {
                                e.join(",")
                ...
                if ("@theme" === e.name) {
                    let [t, o] = function(e) {
                        let t = 0,
                            r = null;
                        for (let n of R(e, " ")) "reference" === n ? t |= 2 : "inline" === n ? t |= 1 : "default" === n ? t |= 4 : "static" === n ? t |= 8 : n.startsWith("prefix(") && n.endsWith(")") && (r = n.slice(7, -1));
                        return [t, r]
                    }(e.params);
                    if (n.reference && (t |= 2), o) {
                        if (!Ht.test(o)) throw new Error(`The prefix "${o}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only.`);
                        c.prefix = o
                    }
                    return A(e.nodes, (r => {
                        if ("at-rule" === r.kind && "@keyframes" === r.name) return c.addKeyframes(r), 1;
                        if ("comment" === r.kind) return;
                        if ("declaration" === r.kind && r.property.startsWith("--")) return void c.add(a(r.property), r.value ?? "", t);
                        let n = j([k(e.name, e.params, [r])]).split("\n").map(((e, t, r) => `${0===t||t>=r.length-2?" ":">"} ${e}`)).join("\n");
                        throw new Error(`\`
                            @theme` blocks must only contain custom properties or \`
                            @keyframes`.\n\n${n}`)
        ...
        if (v.length > 0) {
            for (let e of v) {
                let t = w("&", e.nodes),
                    r = e.params,
                    n = K.parseVariant(r);
                if (null === n) throw new Error(`Cannot use \`
                    @variant` with unknown variant: ${r}`);
                if (null === Pe(t, n, K.variants)) throw new Error(`Cannot use \`
                    @variant` with variant: ${r}`);
                Object.assign(e, t)
            }
            i |= 32
        }
        return i |= Ne(e, K), i |= Ge(e, K), A(e, ((e, {
            replaceWith: t
        }) => {
    ...
    async function Xt(e, r = {}) {
        let n = t(e),
            o = await async function(e, t = {}) {
                ...
                n.unshift(x("! tailwindcss v4.1.1 | MIT License | https://tailwindcss.com "));
                let u = new Set,
                    d = null,
                    f = 0,
                    p = !1;
                ...
                return {
                    ...
                    build(o) {
                        ...
                        return s || f !== m.length ? (f = m.length, i.nodes = m, d = T(n, r, t.polyfills), d) : (d ??= T(n, r, t.polyfills), d)
                    }
                }
            }(n, r), a = n, i = e;
        return {
        ...
        try {
            let r = function() {
                ...
                if ("tailwindcss/utilities" === e || "tailwindcss/utilities.css" === e || "./utilities.css" === e) return {
                    base: t,
                    content: Jt.utilities
                };
                throw new Error(`The browser build does not support @import for "${e}"`)
            }();
            return ir.hit("Loaded stylesheet", {
                id: e,
                base: t,
                size: r.content.length
            }), r
        } catch (r) {
            throw ir.hit("Failed to load stylesheet", {
                id: e,
                base: t,
                error: r.message ?? r
            }), r
    ...
    function cr(e) {
        or = or.then((async function() {
            if (!Qt && "full" !== e) return;
            let t = ar++;
            ir.start(`Build #${t} (${e})`), "full" === e && await async function() {
                ...
                if (t.includes("@import") || (t = `@import "tailwindcss";${t}`), ir.end("Reading Stylesheets", {
                        size: t.length,
                        changed: rr !== t
                    }), rr !== t) {
            ...
            }(), ir.start("Build"), await async function(e) {
                if (!Qt) return;
                let t = new Set;
                ir.start("Collect classes");
                for (let e of document.querySelectorAll("[class]"))
                    for (let r of e.classList) tr.has(r) || (tr.add(r), t.add(r));
                ir.end("Collect classes", {
                    count: t.size
                }), (0 !== t.size || "incremental" !== e) && (ir.start("Build utilities"), nr.textContent = Qt.build(Array.from(t)), ir.end("Build utilities"))
            }(e), ir.end("Build"), ir.end(`Build #${t} (${e})`)
        })).catch((e => ir.error(e)))
    }
    ...
    new MutationObserver((e => {
        let t = 0,
            r = 0;
        for (let n of e) {
            for (let e of n.addedNodes) e.nodeType === Node.ELEMENT_NODE && "STYLE" === e.tagName && e.getAttribute("type") === er && (dr(e), t++);
        ...
        childList: !0,
        subtree: !0
    }), cr("full"), document.head.append(nr)
})();
//# sourceMappingURL=/sm/df24a1006ec2bffed4100b5a3b47635a9325933643777bcd8aad55066b28c752.map